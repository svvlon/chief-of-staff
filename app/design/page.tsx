                ...
                {status === 'complete' && (
                  <div className="bg-white p-10 rounded-[2rem] shadow-2xl border-l-[12px] border-green-500 animate-in fade-in slide-in-from-right-10">
                    ...
                    <p className="text-slate-600 text-lg mb-8 mt-4 leading-relaxed">
                      Our agents analyzed your input: <strong className="text-blue-600">"{userInput}"</strong>. 
                      We suggest automating the documentation step which will reduce delay by <span className="font-black text-slate-900 bg-yellow-200 px-1">2.5 hours</span>.
                    </p>
